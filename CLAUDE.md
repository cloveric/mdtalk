...
```
第1次讨论：A 审查代码，提出问题清单
           B 逐条核对 A 的发现，给出【同意/部分同意/不同意】
           → 共识检测：只看 B 的结论（A 是提问的，不是表态的）
             ✓ B 说"结论：同意"或"结论：部分同意" → 达成共识
             ✗ B 说"结论：不同意" → 进入第2次讨论（如果 max_exchanges > 1）

第2次讨论：A 回应 B 的意见（可能说服 B，也可能被 B 说服）
           B 再次回应 A
           → 共识检测：A 和 B 都需要写结论关键词
             ✓ 双方都说"结论：同意"或"结论：部分同意" → 达成共识
             ✗ 任一方说"结论：不同意" → 继续

第3~N次讨论：同上，继续辩论直到达成共识或耗尽次数
```
