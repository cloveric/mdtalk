...
![MDTalk Dashboard](assets/dashboard.png)

*Real-time dashboard showing Claude (Agent A) and Codex (Agent B) reviewing code*

*实时仪表盘：Claude（Agent A）和 Codex（Agent B）正在审查代码*
